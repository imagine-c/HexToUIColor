...
! function(r) {
  r.fn.colourBrightness = function() {
    function r(r) {
      for (var t = "";
        "html" != r[0].tagName.toLowerCase() && (t = r.css("background-color"), "rgba(0, 0, 0, 0)" == t || "transparent" == t);) r = r.parent();
      return t
    }
...
$(window).load(function() {
  ...
  function hashColour() {
    ...
    if (randomColor) {
      ...
      randomColor = $.rgbHex($('#hex').val());
      $('#rgb').val(randomColor);
      var uiColor = hexToRgb($('#hex').val());
      document.getElementById('uiColor').innerHTML = uiColor;
    } else {
      $('#hex').val('');
      $('#rgb').val('');
    }
  ...
  $hex.bind('blur keyup', function(e) {
    ...
    var colorHtml = hexToRgb($('#hex').val());
    document.getElementById('uiColor').innerHTML = colorHtml;
  ...
  function hexToRgb(r, t) {
    var n = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r),
      a = function() {
        return void 0 == this.alpha ? "UIColor(red: " + this.r + " / 255, green: " + this.g + " / 255, blue: " + this.b + " / 255, alpha: 1.0)" : (this.alpha > 1 ? this.alpha = 1 : this.alpha < 0 && (this.alpha = 0), "UIColor(red: " + this.r + " / 255, green: " + this.g + " / 255, blue: " + this.b + " / 255, alpha: " + this.alpha + ")")
      };
    return void 0 == t ? n ? {
      r: parseInt(n[1], 16),
      g: parseInt(n[2], 16),
  ...
  function rgbToHex(r, t, n) {
    ...
    if (void 0 == t || void 0 == n) {
      if ("string" == typeof r) {
        var i = /^rgb[a]?\(([\d]+)[ \n]*,[ \n]*([\d]+)[ \n]*,[ \n]*([\d]+)[ \n]*,?[ \n]*([.\d]+)?[ \n]*\)$/i.exec(r);
        return rgbToHex(parseInt(i[1]), parseInt(i[2]), parseInt(i[3]))
      }
      return void 0 == r.r || void 0 == r.g || void 0 == r.b ? null : rgbToHex(r.r, r.g, r.b)
    }
    var e = r;
    return "#" + a(e) + a(t) + a(n)
  }
